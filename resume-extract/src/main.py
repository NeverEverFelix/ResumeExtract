...
GENERATION_WORKER_ENABLED = _env_flag("GENERATION_WORKER_ENABLED", default=False)
...
PDF_WORKER_ENABLED = _env_flag("PDF_WORKER_ENABLED", default=False)
...
async def run_worker_forever() -> None:
    ...
    _log_event(
        ...
        pdf_worker_enabled=PDF_WORKER_ENABLED,
